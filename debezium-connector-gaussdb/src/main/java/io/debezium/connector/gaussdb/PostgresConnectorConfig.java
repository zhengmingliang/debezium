...
import io.debezium.connector.gaussdb.connection.MessageDecoder;
...
import io.debezium.connector.gaussdb.connection.ReplicationConnection;
import io.debezium.connector.gaussdb.connection.pgoutput.PgOutputMessageDecoder;
import io.debezium.connector.gaussdb.connection.pgproto.PgProtoMessageDecoder;
import io.debezium.connector.gaussdb.connection.wal2json.NonStreamingWal2JsonMessageDecoder;
import io.debezium.connector.gaussdb.connection.wal2json.StreamingWal2JsonMessageDecoder;
import io.debezium.connector.gaussdb.snapshot.AlwaysSnapshotter;
import io.debezium.connector.gaussdb.snapshot.InitialOnlySnapshotter;
import io.debezium.connector.gaussdb.snapshot.InitialSnapshotter;
import io.debezium.connector.gaussdb.snapshot.NeverSnapshotter;
...
public class PostgresConnectorConfig extends RelationalDatabaseConnectorConfig {
    ...
    public static final Field SSL_SOCKET_FACTORY = Field.create(DATABASE_CONFIG_PREFIX + "sslfactory")
            ...
            .withImportance(Importance.MEDIUM)
            .withDescription(
                    "A name of class to that creates SSL Sockets. Use com.huawei.gauss200.jdbc.ssl.NonValidatingFactory to disable SSL validation in development environments");
