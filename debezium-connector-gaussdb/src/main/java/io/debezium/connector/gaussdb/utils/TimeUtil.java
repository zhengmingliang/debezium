/*
 * Copyright zhengmingliang.
 *
 * Licensed under the Apache Software License version 2.0, available at http://www.apache.org/licenses/LICENSE-2.0
 */
package io.debezium.connector.gaussdb.utils;
...
import com.huawei.gauss200.jdbc.core.JavaVersion;
...
public class TimeUtil {
    ...
    private static final Duration PG_EPOCH_DIFF = Duration.between(Instant.EPOCH, LocalDate.of(2000, 1, 1).atStartOfDay().toInstant(ZoneOffset.UTC));
     ...
     */
    public synchronized Timestamp toTimestamp(Calendar cal,
                                              String s)
            throws SQLException {
        if (s == null) {
            return null;
    ...
    public synchronized Time toTime(
                                    Calendar cal, String s)
            throws SQLException {
    ...
    public synchronized Date toDate(Calendar cal,
                                    String s)
            throws SQLException {
        // 1) Parse backend string
     ...
     * Do not use this method in {@link ResultSet#getString(int)}
    ...
    public static <T extends Object> T castNonNull(
                                                   T ref) {
